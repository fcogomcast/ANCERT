...
public class ConversorParametrosLanzador 
{
	...
	/**
	 * Devuelve la cadena con los caracteres especiales de XML sustituídos por entidades
	 * @param cadena
	 * @return
	 */
	public String getEscapedString(String cadena){
	...
	public void setParametro(String valor, TIPOS tipo)
	{
		...
		{
			//CRUBENCVS 24/10/2022. 46332. Escapamos los caracteres especiales.
			miVal=getEscapedString(valor);
		}
