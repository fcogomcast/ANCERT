...
public class Utils {
	...
	/**
	 * Recupera un checkcum basado en un identificador único. Se asegura que el
	...
	/**
	 * Devuelve un objeto de respuesta con el resultado establecido en función
	 * de un código de mensaje que se le pasa.
	 * 
	 * @param res -
	...
	/**
	 * Recupera el directorio relativo al dominio donde se situarán los ficheros
	...
	public static SOAPFaultException createSOAPFaultException(
		...
		try {
			...
			System.out
					.println("Solicitud Escrituras:===>Error grave al construir la excepción de SOAP."
							+ ex.getMessage());
			throw new RuntimeException(
					"Excepción grave al devolver el mensaje.");
	 ...
	 * 
	 * @param msg
	 *            Mensaje SOAP sobre el que se generará el error. Se utilizará
	 *            para añadirle la sección SOAP Fault
	 * @param reason
	 *            Texto de razón de error (aparecerá en el faultString )
	 * @param codigo
	 *            Código de error que aparecerá en el detalle.
	 * @param mensaje
	 *            Mensaje que aparecerá en el detalle.
	 */
