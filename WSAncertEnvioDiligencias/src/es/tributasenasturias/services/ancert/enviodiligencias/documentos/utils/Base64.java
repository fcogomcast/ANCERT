...
*/
public class Base64
{	//public static Logger objLog = Logger.getLogger("webservicesportlet");
 ...
 */
 ...
 public static void main(String[] args)
 {
     ...
     if (args.length == 0)
     {
         //objLog.debug("usage:  java Base64 [-d[ecode]] filename");
         System.exit(0);
     }
     ...
     if (!file.exists())
     {
         //objLog.debug("Error:  file '" + filename + "' doesn't exist!");
         System.exit(0);
     }
