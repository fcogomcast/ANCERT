...
public class IndicesFiscalesServlet extends javax.servlet.http.HttpServlet implements javax.servlet.Servlet {
	 ...
	 */
	private CallContext inicializarContext() throws IndicesFiscalesException
	{
		...
		{
			throw new IndicesFiscalesException("Error en preferencias.",per);
		}
		String idSesion  = Utils.getIdLlamada();
		if ("".equals(idSesion))
		{
			throw new IndicesFiscalesException("No se puede recuperar el identificador de sesión.");
		}
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		} catch (IndicesFiscalesException ce)
		{
