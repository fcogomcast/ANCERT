...
public class SoapClientHandler implements SOAPHandler<SOAPMessageContext> {
	...
	private void log(SOAPMessageContext context)
	{
		...
		try
		{
			...
			log=new TributasLogger(pref.getModoLog(), pref.getDirectorioRaizLog(),pref.getFicheroLogClient(), sesionId);
		...
		catch (javax.xml.soap.SOAPException ex)
		{
			...
			SOAPUtils.generateSOAPErrMessage(context.getMessage(), "Error en proceso de comunicación plusvalía ANCERT <--> Servicio Remoto."	, "0002", "SOAP Handler", true);
		}
		...
		catch (PreferenciasException ex)
		{
			...
			System.err.println ("Servicio de plusvalías para ANCERT: Error de preferencias en manejador SOAP ("+SoapClientHandler.class.getName()+":"+ex.getMessage());
			SOAPUtils.generateSOAPErrMessage(context.getMessage(), "Error en proceso de comunicación Servicio plusvalías para ancert <--> Servicio Remoto."	, "0002", "SOAP Handler", true);
		}
	}
	@Override
