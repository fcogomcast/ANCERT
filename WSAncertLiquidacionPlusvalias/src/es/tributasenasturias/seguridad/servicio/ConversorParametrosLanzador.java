...
{
	private Map<TIPOS,String> m_tipos = new HashMap<TIPOS, String>();
	private List<String> m_valorParametros = new ArrayList<String>();
	private List<String> m_formatoParametros = new ArrayList<String>();
	private List<TIPOS> m_tipoParametros = new ArrayList<TIPOS>();
	...
	public List<HashMap<String,String>> decodifica(String mensaje)
	{
		List<HashMap<String,String>> listaFilas = new ArrayList<HashMap<String,String>>();
