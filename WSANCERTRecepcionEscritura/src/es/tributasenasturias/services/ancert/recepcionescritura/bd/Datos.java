...
public class Datos implements IContextReader
{
	...
	//Tiempo de Timeout. 60 segundos para respuesta de lanzador, no deber�a tardar m�s nunca.
	...
	public Datos(CallContext context) throws SystemException
	{
		...
		{
			throw ex; //Esta excepci�n es grave, no se deber�a convertir.
		}
		catch (Exception ex)
		{
	...
	/**
	 * Devuelve un 'S' si la escritura est� duplicada en la tabla, o 'N' si no.
	 * @param idescritura Datos de la escritura.
	 * @return 'S' si est� duplicada, 'N' si no.
	 * @throws SystemException En caso de que haya un problema al comprobar si la escritura est� duplicada
	 */
	public String escrituraDuplicada(EscrituraDO idescritura) throws SystemException
	{
		...
		{
			throw new SystemException ("Problema al comprobar si la escritura est� duplicada.",ex);
		}
	}
	/**
	 * Devuelve el id de solicitud, que puede ser el que exist�a si la solicitud se hizo desde
	 * EPST, o el que que se ha creado al insertar la solicitud autom�tica si la solicitud se cre�
	 * porque nos lleg� una escritura que no hab�amos solicitado.
	 * @param idescritura Datos de la escritura.
	 * @return Id de solicitud o cadena vac�a si no existe
	...
	public String finalizarRecepcionEscritura(EscrituraDO idescritura) throws SystemException
	{
		...
		{
			throw new SystemException ("Problema al finalizar la recepci�n de escritura.",ex);
		}
	}
	...
	/**
	 * M�todo que devuelve el error en la ultima llamada a un procedimiento de esta clase.
	 * Los errores en llamada son devueltos en formato XML, este procedimiento devuelve el error
	 * extra�do en formato de cadena.
	 * @return
	 */
